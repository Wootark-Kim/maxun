          ...
          try {
            ...
            if (previousRun) {
              ...
              const hasChanged =
                ...
                normalize(previousText) !== normalize(currentText || '');
              ...
              if (hasChanged) {
                ...
                logger.log(
                  'info',
                  `Scheduled run ${plainRun.runId} has changes compared to previous run ${previousRun.runId}`
                );
              }
            }
            ...
            logger.log(
              'warn',
              `Run comparison failed for scheduled run ${plainRun.runId}: ${compareError.message}`
            );
          }
        }
